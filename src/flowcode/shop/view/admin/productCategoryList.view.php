<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(".page-header > h1 > a").click(function() {
            createEntity("New ProductCategory", $(this).attr("data-form"), $(this).attr("data-form-action"));
        });

        /* update */
        $("a.edit").click(function() {
            updateEntity("Edit ProductCategory", "/adminProductCategory/edit/" + $(this).attr("data-form-entity"), "/adminProductCategory/save");
        });

        /* delete */
        $("a.delete").click(function() {
            if (confirm("Estás seguro?")) {
                deleteEntity("adminProductCategory/delete/" + $(this).attr("data-form-entity"));
            }
        });
    });
</script>
<div class="page-header">
    <h1>ProductCategory List
        <a class="btn" data-form="/adminProductCategory/create" data-form-action="/adminProductCategory/save" ><i class="icon-plus icon-white"></i> Nuevo</a>
    </h1>
</div>

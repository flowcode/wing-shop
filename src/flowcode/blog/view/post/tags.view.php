<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(".page-header > h1 > a").click(function() {
            createEntity("New Tag", $(this).attr("data-form"), $(this).attr("data-form-action"));
        });

        /* update */
        $("a.edit").click(function() {
            updateEntity("Edit Role", "/adminBlog/editTag/" + $(this).attr("data-form-entity"), "/adminBlog/saveTag");
        });

        /* delete */
        $("a.delete").click(function() {
            if (confirm('Estás seguro?')) {
                deleteEntity("/adminBlog/deleteTag/" + $(this).attr("data-form-entity"));
            }
        });
...
<div class="page-header">
    <h1>Tags
        <a class="btn create" data-form="/adminBlog/createTag" data-form-action="/adminBlog/saveTag"><i class="icon-plus icon-white"></i> Nuevo</a>
    </h1>
</div>
    ...
    <?php foreach ($viewData['pager']->getItems() as $entity): ?>
        <tr>
            ...
            <td style="width: 100px;">
                <a title="Modificar" data-form-entity="<? echo $entity->getId() ?>" class="btn btn-mini edit">
                    <i class="icon-edit icon-white"></i>
                </a>
                <a title="Eliminar" data-form-entity="<? echo $entity->getId() ?>" class="btn btn-mini btn-danger delete">
